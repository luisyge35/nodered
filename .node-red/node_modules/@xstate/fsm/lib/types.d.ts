...
export declare namespace StateMachine {
    ...
    interface Config<TContext extends object, TEvent extends EventObject> {
        id?: string;
        initial: string;
        context?: TContext;
        states: {
    ...
    interface Service<TContext extends object, TEvent extends EventObject, TState extends Typestate<TContext> = any> {

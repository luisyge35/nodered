...
class='form-row'> <label style='min-width:160px' for='node-input-showStatusActivities'><i class='fa fa-th'></i> <span 
...
</p> <p>Unit-Id (0..255 tcp | 1..247 serial) - leave empty, otherwise it overrides the default Unit-ID of client config
